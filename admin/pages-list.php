...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/pages-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Dec 2022 10:58:40 GMT -->
                ...
                <div class="nav-right col">
                    <ul class="nav-menus">
                                ...
                                <li>
                                    <div class="media">
                                        <div class="media-body">
                                            <h6 class="mt-0"><span><i class="shopping-color" data-feather="shopping-bag"></i></span>Your order ready for
                                                Ship..!</h6>
                        ...
                        <li class="onhover-dropdown">
                            <div class="media align-items-center"><img class="align-self-center pull-right img-50 blur-up lazyloaded" src="assets/images/dashboard/user3.html" alt="header-user">
            ...
            <div class="page-sidebar">
                ...
                <div class="sidebar custom-scrollbar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a class="sidebar-header" href="support-ticket.html"><i data-feather="phone"></i><span>Support Ticket</span>
                            </a>
                        </li>
                        ...
                        <div class="chat-box">
                            <div class="people-list friend-list">
                                <ul class="list">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded" src="assets/images/dashboard/user1.html" alt="">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded" src="assets/images/dashboard/user2.html" alt="">
                                        <div class="status-circle online"></div>
                                        <div class="about">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded" src="assets/images/dashboard/user3.html" alt="">
                                        <div class="status-circle online"></div>
                                        <div class="about">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded" src="assets/images/dashboard/user5.html" alt="">
                                        <div class="status-circle away"></div>
                                        <div class="about">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded" src="assets/images/dashboard/designer.html" alt="">
                                        <div class="status-circle online"></div>
                                        <div class="about">
